...
<h1><?php echo lang('entitleddays_contract_index_title');?> <span class="muted"><?php echo $contract_name; ?></span></h1>
</div>
    <div class="span12">
<table id="entitleddayscontract" cellpadding="0" cellspacing="0" border="0" class="table table-bordered" width="100%">
<thead>
    <tr>
      <th>&nbsp;</th>
...
<div id="frmAddEntitledDays" class="modal hide fade">
        ...
        <div class="modal-body">
            ...
            <label class="col-md-3" for="viz_startdate"><?php echo lang('entitleddays_contract_index_field_start');?></label>
            <div class="input-append">
                <input type="text" id="viz_startdate" name="viz_startdate" required />
                <button class="btn btn-primary" onclick="set_current_period();"><?php echo lang('entitleddays_contract_index_button_current');?></button>
            </div><br />
            <input type="hidden" name="startdate" id="startdate" />
            </div>
            <div class="form-group">
            <label class="col-md-3" for="viz_enddate"><?php echo lang('entitleddays_contract_index_field_end');?></label>
            <input type="text" id="viz_enddate" name="viz_enddate" required /><br />
            <input type="hidden" name="enddate" id="enddate" />
            </div>
            <div class="form-group">
            <label class="col-md-3" for="type"><?php echo lang('entitleddays_contract_index_field_type');?></label>
            ...
            <div class="form-group">
            <label class="col-md-3" for="days" required><?php echo lang('entitleddays_contract_index_field_days');?></label>
            <input type="text" class="input-mini" name="days" id="days" />
            </div>
            <div class="form-group">
            <label class="col-md-3" for="description"><?php echo lang('entitleddays_contract_index_field_description');?></label>
