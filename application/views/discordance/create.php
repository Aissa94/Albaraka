...
echo form_open('discordance/create', $attributes); ?>
    ...
    &nbsp;
    <a href="<?php echo base_url(); ?>discordance" class="btn btn-danger"><i class="icon-remove icon-white"></i>&nbsp;<?php echo lang('contract_create_button_cancel');?></a>
</form>
